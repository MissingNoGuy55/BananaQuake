...
typedef struct dxpoly_s
{
	struct	dxpoly_s* next;
	struct	dxpoly_s* chain;
	int		numverts;
...
typedef struct msurface_s
{
	...
	dxpoly_t	*polys;				// multiple if warped
...
typedef struct {
	...
	class CDXTexture*	dxtextures[MAX_SKINS][4];
