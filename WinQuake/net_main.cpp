...
int	NET_GetMessage (qsocket_t *sock)
{
	...
	if (ret > 0)
	{
		...
		if (recording)
		{
			...
			vcrGetMessage.session = (VOID_P)sock;
...
int NET_SendMessage (qsocket_t *sock, sizebuf_t *data)
{
	...
	if (recording)
	{
		...
		vcrSendMessage.session = (VOID_P)sock;
		vcrSendMessage.r = r;
...
void NET_Init (void)
{
	...
	{
		s = g_MemCache->Hunk_AllocName<qsocket_t>(sizeof(qsocket_t), "qsocket");
