...
void M_SinglePlayer_Draw (void)
{
	...
	M_DrawTransPic (54, 32 + m_singleplayer_cursor * 20,g_GLRenderer->Draw_CachePic( va("gfx/menudot%i.lmp", f+1 ) ) );
}
...
void M_MultiPlayer_Draw (void)
{
	...
	M_DrawTransPic (54, 32 + m_multiplayer_cursor * 20,g_GLRenderer->Draw_CachePic( va("gfx/menudot%i.lmp", f+1 ) ) );
...
void M_Net_Draw (void)
{
	...
	f = (int)(host_time * 10)%6;
	M_DrawTransPic (54, 32 + m_net_cursor * 20,g_GLRenderer->Draw_CachePic( va("gfx/menudot%i.lmp", f+1 ) ) );
}
...
void M_Help_Draw (void)
{
	M_DrawPic (0, 0, g_GLRenderer->Draw_CachePic ( va("gfx/help%i.lmp", help_page)) );
}
