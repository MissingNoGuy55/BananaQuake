...
=================
*/
bool CDXRenderer::R_CullBox (vec3_t mins, vec3_t maxs)
{
	int		i;
...
void CDXRenderer::R_RotateForEntity (entity_t *e)
{
...
================
*/
mspriteframe_t * CDXRenderer::R_GetSpriteFrame (entity_t *currententity)
{
	msprite_t		*psprite;
...
=================
*/
void CDXRenderer::R_DrawSpriteModel (entity_t *e)
{
	vec3_t	point;
    ...
    g_pDXRenderer->DX_Bind(frame->gltexture);
...
=============
*/
void CDXRenderer::DX_DrawAliasFrame (aliashdr_t *paliashdr, int posenum)
{
	float 	l;
	float	vertcolor[4];
	trivertx_t *verts;
...
=================
*/
void CDXRenderer::R_SetupAliasFrame (int frame, aliashdr_t *paliashdr)
{
	int				pose, numposes;
	float			interval;
...
=================
*/
void CDXRenderer::R_DrawAliasModel (entity_t *e)
{
	int			i;
	int			lnum;
	vec3_t		dist;
...
=============
*/
void CDXRenderer::R_DrawEntitiesOnList (void)
{
	int		i;
...
=============
*/
void CDXRenderer::R_DrawViewModel (void)
{
...
============
*/
void CDXRenderer::R_PolyBlend (void)
{
...
int CDXRenderer::SignbitsForPlane (mplane_t *out)
{
	int	bits, j;
...
void CDXRenderer::R_SetFrustum (void)
{
	int		i;
...
===============
*/
void CDXRenderer::R_SetupFrame (void)
{
...
=============
*/
void CDXRenderer::R_SetupGL (void)
{
	float	screenaspect;
...
================
*/
void CDXRenderer::R_RenderScene (void)
{
	R_SetupFrame ();
...
=============
*/
void CDXRenderer::R_Mirror (void)
{
	float		d;
	msurface_t	*s;
	entity_t	*ent;
